...
public class PostListExtractor extends AbstractPostlistExtractor {
	...
	/*
	 * 构造函数*/
	PostListExtractor(PostList list){
		super(list);
		super._connect.setCharset("gbk");
	}
	...
	protected void initCache() {
		super._cache=new BBShiapkCache();
	}

	@Override
	protected void initBlockManager() {
		super._blockManager=new BlockManagerhiapk();
		
	}

	@Override
	protected void initURLMaker() {
		super._urlMaker=new URLMakerhiapk();
